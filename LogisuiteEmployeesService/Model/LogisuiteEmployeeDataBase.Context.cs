...
namespace LogisuiteEmployeesService.Model
{
    ...
    public partial class LogisuiteEntities : DbContext
    {
        ...
        public virtual int InsertValue(string name, string lastName, Nullable<System.DateTime> dateofBirth, Nullable<decimal> annualSalary, string address, Nullable<long> phone, Nullable<long> socialSecurityNumber)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertValue", nameParameter, lastNameParameter, dateofBirthParameter, annualSalaryParameter, addressParameter, phoneParameter, socialSecurityNumberParameter);
        }
    
        public virtual int UpdateValue(Nullable<int> id, string name, string lastName, Nullable<System.DateTime> dateofBirth, Nullable<decimal> annualSalary, string address, Nullable<long> phone, Nullable<long> socialSecurityNumber)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateValue", idParameter, nameParameter, lastNameParameter, dateofBirthParameter, annualSalaryParameter, addressParameter, phoneParameter, socialSecurityNumberParameter);
        }
